# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-05-08 01:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usr.Goods')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_out_time', models.DateTimeField(auto_now_add=True)),
                ('u_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usr.UserModel')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usr.UserModel'),
        ),
        migrations.AddField(
            model_name='ordergoodsmodel',
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usr.OrderModel'),
        ),
        migrations.AddField(
            model_name='cartmodel',
            name='goods',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usr.Goods'),
        ),
        migrations.AddField(
            model_name='cartmodel',
            name='user',
